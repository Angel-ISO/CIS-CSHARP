...
:selectName
    ...
    dotnet add !folderName!\!folderName!.csproj package Microsoft.AspNetCore.Authentication.JwtBearer --version 7.0.3
    dotnet add !folderName!\!folderName!.csproj package Microsoft.EntityFrameworkCore --version 7.0.3
    dotnet add !folderName!\!folderName!.csproj package Microsoft.EntityFrameworkCore.Design --version 7.0.3
    dotnet add !folderName!\!folderName!.csproj package Microsoft.Extensions.DependencyInjection --version 7.0.3
    dotnet add !folderName!\!folderName!.csproj package System.IdentityModel.Tokens.Jwt --version 6.32.0
    dotnet add !folderName!\!folderName!.csproj package Serilog.AspNetCore --version 7.0.1
    dotnet add !folderName!\!folderName!.csproj package AutoMapper.Extensions.Microsoft.DependencyInjection --version 12.0.3
    dotnet add !folderName!\!folderName!.csproj package Swashbuckle.AspNetCore --version 6.3.1  REM Instala Swagger
    SET app=Application
    dotnet new classlib -o !app!
    SET persistencia=Persistence
    dotnet new classlib -o !persistencia!
    dotnet add !persistencia!\!persistencia!.csproj package Pomelo.EntityFrameworkCore.MySql --version 7.0.3
    dotnet add !persistencia!\!persistencia!.csproj package Microsoft.EntityFrameworkCore --version 7.0.3
    ...
    dotnet add !dom!\!dom!.csproj package Microsoft.EntityFrameworkCore --version 7.0.3
